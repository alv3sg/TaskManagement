...
from ..domain.entities import User, UserId, Email, PasswordHash, RefreshToken, Inbox
...
class InboxRepository(Protocol):
    ...
    def get_by_user_id(self, user_id: UserId) -> Iterable[Inbox]: ...
    def save(self, inbox: Inbox) -> None: ...
    def revoke(self, inbox_id: str) -> None: ...
    def list(self, *, limit: int = 50, offset: int = 0) -> Iterable[Inbox]: ...
    def update(self, inbox: Inbox) -> Inbox: ...
